...
func setup(t *testing.T, onChainCred node.Credential) (adjudicator, asset wallet.Address) {
...
func deployContracts(t *testing.T, chain node.ChainBackend) (adjudicator, asset wallet.Address) {
