...
func (cb *ChainBackend) DeployAdjudicator(ctx context.Context) (wallet.Address, error) {
...
func (cb *ChainBackend) DeployAsset(ctx context.Context, adjAddr wallet.Address) (wallet.Address, error) {
