...
// NewChainBackendSetup returns a simulated contract backend  with assetHolder, adjudicator contracts deployed.
...
func NewChainBackendSetup(t *testing.T, rng *rand.Rand, cntFundedAccs uint) (_ *ChainBackendSetup) {
	...
	cb := &internal.ChainBackend{Cb: &cbEth}
