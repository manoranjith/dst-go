...
// Package dst defines domain types and interfaces used in this project.
package dst
...
// ChainBackend wraps the methods required for instanting and using components for
...
} // nolint: gofumpt	// unknown false positive
