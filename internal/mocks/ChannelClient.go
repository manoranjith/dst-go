...
func (_m *ChannelClient) ProposeChannel(_a0 context.Context, _a1 *client.BaseChannelProposal) (*client.Channel, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *client.Channel
	if rf, ok := ret.Get(0).(func(context.Context, *client.BaseChannelProposal) *client.Channel); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.Channel)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *client.BaseChannelProposal) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
